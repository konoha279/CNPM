...
<head>
	...
	<title>Tùy chỉnh trang giới thiệu</title>
	...
	<div class="pusher">
		<div class="main-content">
			<div class="ui grid stackable padded">
				<div class="column">
				<h1 class="ui header" style="text-align:center ;margin-top: 30px">CHỈNH SỬA TRANG GIỚI THIỆU</h1>
					<form action="admin/page/gioithieu.htm" method="post">
