...
<head>
<meta charset="utf-8">
<title>Thống kê nhập xuất - tháng</title>
	...
	<div class="pusher">
		<div class="main-content">
			<div class="ui grid stackable padded">
				<div class="column">
					<h2 style="margin-bottom:10px">Thống kê nhập xuất theo tháng</h2>
				</div>
			</div>
			<div class="ui grid stackable padded">
				<div class="column">
					<form class="ui form" action="admin/thongke/thongKeNhapHang-thang.htm" method="post">
						<div class="field">
							<div class="fields">
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Tháng', 'Số lượng phiếu nhập', 'Số lượng phiếu xuất'],
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
        	['Tháng', 'Số lượng loại hàng nhập', 'Số lượng loại hàng xuất'],
          <c:forEach items="${Reports}" var="r">
