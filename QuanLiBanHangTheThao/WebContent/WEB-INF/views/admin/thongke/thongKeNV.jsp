...
<head>
<meta charset="utf-8">
<title>Thống kê nhân viên - ngày</title>
<style type="text/css">
.modal-lg {
	...
	<div class="pusher">
		<div class="main-content">
			<div class="ui grid stackable padded">
				<div class="column">
					<h2 style="margin-bottom:10px">Thống kê tình nhân viên theo ngày</h2>
				</div>
			</div>
			<div class="ui grid stackable padded">
				<div class="column">
					<form class="ui form" action="admin/thongke/thongKeNV.htm" method="post">
						<div class="field">
							<div class="fields">
