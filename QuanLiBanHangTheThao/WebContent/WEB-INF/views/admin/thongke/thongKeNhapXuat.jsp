...
<head>
<meta charset="utf-8">
<title>Thống kê nhập xuất - ngày</title>
	...
	<div class="pusher">
		<div class="main-content">
			<div class="ui grid stackable padded">
				<div class="column">
					<h2 style="margin-bottom:10px">Thống kê nhập xuất theo ngày</h2>
				</div>
			</div>
			<div class="ui grid stackable padded">
				<div class="column">
					<form class="ui form" action="admin/thongke/thongKeNhapHang.htm" method="post">
						<div class="field">
							<div class="fields">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Ngày', 'Số lượng phiếu nhập', 'Số lượng phiếu xuất'],
